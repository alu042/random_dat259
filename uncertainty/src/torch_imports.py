...
from torchvision.models import densenet121MC, densenet161MC, densenet169MC, densenet201MC
...
def dn121MC(pre): return children(densenet121MC(pre))[0]
def dn161MC(pre): return children(densenet161MC(pre))[0]
def dn169MC(pre): return children(densenet169MC(pre))[0]
def dn201MC(pre): return children(densenet201MC(pre))[0]
